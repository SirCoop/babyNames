  ...
  .directive('stPagination', ['stConfig', function (stConfig) {
    return {
      ...
      templateUrl: function (element, attrs) {
        //console.log('attrs inside stPagination directive ', attrs);
        if (attrs.stTemplate) {
      ...
      link: function (scope, element, attrs, ctrl) {
        //console.log('scope inside stPagination directive ', scope);
        //console.log('element inside stPagination directive ', element);
        //console.log('attrs inside stPagination directive ', attrs);
        //console.log('ctrl inside stPagination directive ', ctrl);

        //stConfig.pagination.template = attrs.stTemplate ? attrs.stTemplate : scope.customTpl;
